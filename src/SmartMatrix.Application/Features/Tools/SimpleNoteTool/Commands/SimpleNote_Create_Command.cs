...
namespace SmartMatrix.Application.Features.Tools.SimpleNoteTool.Commands
{
    public class SimpleNote_Create_Command : IRequest<Result<SimpleNote_Create_Response>>
    {
        ...
        {            
            ...
            private readonly IToolUnitOfWork _unitOfWork;
            
            public Handler(IMapper mapper, ISimpleNoteRepo simpleNoteRepo, IToolUnitOfWork unitOfWork)
            {
                _mapper = mapper;
