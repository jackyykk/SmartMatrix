...
namespace SmartMatrix.Application.Features.Apps.SimpleNoteApp.Commands
{
    public class SimpleNote_Create_Command : IRequest<Result<SimpleNote_Create_Response>>
    {
        ...
        {            
            ...
            public Handler(IMapper mapper, ISimpleNoteRepo simpleNoteRepo, IAppUnitOfWork unitOfWork)
            {
                _mapper = mapper;
