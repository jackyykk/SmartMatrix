...
{
    public class ToolWriteRepo<T, TId> : IToolWriteRepo<T, TId> where T : AuditableEntity<TId>
    {
        const double DefaultCommandTimeoutInSeconds = 60;

        private readonly ToolWriteDbContext _writeDbContext;        
        public IToolWriteDbContext ToolWriteDb => _writeDbContext;
        ...
        public ToolWriteRepo(IToolReadDbContext readDbContext, IToolWriteDbContext writeDbContext)
        {            
            _writeDbContext = (ToolWriteDbContext)writeDbContext;
