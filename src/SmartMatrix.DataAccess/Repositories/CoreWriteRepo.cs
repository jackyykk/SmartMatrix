...
{
    public class CoreWriteRepo<T, TId> : ICoreWriteRepo<T, TId> where T : AuditableEntity<TId>
    {
        const double DefaultCommandTimeoutInSeconds = 60;

        private readonly CoreWriteDbContext _writeDbContext;        
        public ICoreWriteDbContext CoreWriteDb => _writeDbContext;
        ...
        public CoreWriteRepo(ICoreReadDbContext readDbContext, ICoreWriteDbContext writeDbContext)
        {            
            _writeDbContext = (CoreWriteDbContext)writeDbContext;
