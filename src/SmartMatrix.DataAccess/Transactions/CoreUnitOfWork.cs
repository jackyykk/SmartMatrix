...
namespace SmartMatrix.DataAccess.Transactions
{
    public class CoreUnitOfWork : ICoreUnitOfWork
    {
        ...
        private readonly ICoreWriteDbContext _writeDbContext;
        private bool disposed;

        public ICoreWriteDbContext WriteDbContext => _writeDbContext;

        public CoreUnitOfWork(ICoreWriteDbContext dbContext, IAuthenticatedUserService userSvc)
        {
