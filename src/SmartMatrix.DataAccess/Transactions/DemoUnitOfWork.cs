...
namespace SmartMatrix.DataAccess.Transactions
{
    public class DemoUnitOfWork : IDemoUnitOfWork
    {
        ...
        private readonly IDemoWriteDbContext _writeDbContext;
        private bool disposed;

        public IDemoWriteDbContext WriteDbContext => _writeDbContext;

        public DemoUnitOfWork(IDemoWriteDbContext dbContext, IAuthenticatedUserService userSvc)
        {
