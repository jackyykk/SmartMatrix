...
{
    public class CoreReadDbConnection : ICoreReadDbConnection, IDisposable
    {
        ...
        public CoreReadDbConnection(IConfiguration configuration)
        {
            connection = new SqlConnection(configuration.GetConnectionString("CoreReadConnection"));
        }
