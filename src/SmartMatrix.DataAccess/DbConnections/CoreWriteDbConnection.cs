...
{
    public class CoreWriteDbConnection : ICoreWriteDbConnection
{
    ...
    public CoreWriteDbConnection(IConfiguration configuration)
    {
        connection = new SqlConnection(configuration.GetConnectionString("CoreWriteConnection"));
    }
