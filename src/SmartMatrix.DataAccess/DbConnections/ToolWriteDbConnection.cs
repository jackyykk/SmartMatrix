...
{
    public class ToolWriteDbConnection : IToolWriteDbConnection
{
    ...
    public ToolWriteDbConnection(IConfiguration configuration)
    {
        connection = new SqlConnection(configuration.GetConnectionString("ToolWriteConnection"));
    }
