...
{
    public class ToolReadDbConnection : IToolReadDbConnection, IDisposable
    {
        ...
        public ToolReadDbConnection(IConfiguration configuration)
        {
            connection = new SqlConnection(configuration.GetConnectionString("ToolReadConnection"));
        }        
